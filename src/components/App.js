...
const App = (props) => {
  ...
  const playAudio = (sample) => {
    ...
    let playPromise = document.getElementById(sample).play();
      ...
      <div class="inner-container" id="drum-machine">
        <div class="pad-bank">
          ...
          <div className="drum-pad" id="Heater-3" onClick={() => playAudio("E")}>
            <audio className="clip" id="E" src="./audio-samples/Heater-3.mp3"></audio>
            E
          </div>
          <div className="drum-pad" id="Heater-4" onClick={() => playAudio("A")}>
            <audio className="clip" id="A" src="./audio-samples/Heater-4_1.mp3"></audio>
            A
          </div>
          <div className="drum-pad" id="Clap" onClick={() => playAudio("S")}>
            <audio className="clip" id="S" src="./audio-samples/Heater-6.mp3"></audio>
            S
          </div>
          <div className="drum-pad" id="Open-HH" onClick={() => playAudio("D")}>
            <audio className="clip" id="D" src="./audio-samples/Dsc_Oh.mp3"></audio>
            D
          </div>
          ...
          <div className="drum-pad" id="Kick" onClick={() => playAudio("X")}>
            <audio className="clip" id="X" src="./audio-samples/RP4_KICK_1.mp3"></audio>
            X
          </div>
          <div className="drum-pad" id="Closed-HH" onClick={() => playAudio("C")}>
            <audio className="clip" id="C" src="./audio-samples/Cev_H2.mp3"></audio>
            C
          </div>
        </div>
        <div class="logo">
